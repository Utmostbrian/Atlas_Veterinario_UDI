    ...
    if (this.state.hasError) {
      return (
        <div style={{
          ...
          textAlign: 'center', fontFamily: "'Figtree', system-ui, sans-serif", background: 'var(--cream, #F4F6F8)',
        }}>
          ...
          <h2 style={{ color: 'var(--dark, #0F172A)', fontFamily: "'Figtree', system-ui, sans-serif", marginBottom: '.5rem' }}>
            Algo salió mal
          </h2>
