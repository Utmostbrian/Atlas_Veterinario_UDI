...
<head>
  ...
  <style>
    :root { --blue:#DA291C; --dark:#0F172A; --text:#374151; --soft:#6B7280; --gl:#f8f9fa; --border:#e5e7eb; }
    * { box-sizing:border-box; margin:0; padding:0; }
    body { font-family:'IBM Plex Sans',system-ui,sans-serif; background:#fff; padding:32px; color:var(--text); }
  ...
  return (
    <div className="page-inner">
        ...
        <div className="receta-body">
          ...
          <div className="receta-section">
            ...
            <button
              type="button"
              onClick={addDrug}
              style={{ width: '100%', padding: '9px', border: '1px dashed var(--border)', borderRadius: 'var(--rs)', color: 'var(--soft)', fontSize: '.82rem', background: 'none', cursor: 'pointer', marginTop: 4, transition: '.2s', fontFamily: 'var(--sans)' }}
            >
              + Agregar medicamento
            </button>
          </div>
      ...
      {generated && validDrugsForPreview.length > 0 && (
        <div>
          <div ref={previewRef} className="receta-preview show" style={{ fontFamily: 'var(--sans)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 16, paddingBottom: 16, borderBottom: '2px solid var(--blue)' }}>
              ...
              <div>
                <div style={{ fontFamily: 'var(--sans)', fontSize: 15, fontWeight: 800, color: 'var(--blue)' }}>Facultad de Veterinaria - UDI</div>
                <div style={{ fontSize: 12, color: 'var(--soft)' }}>Universidad para el Desarrollo y la Innovacion - Santa Cruz</div>
              </div>
            </div>

            <h2 style={{ fontSize: 14, fontWeight: 800, textAlign: 'center', color: 'var(--dark)', marginBottom: 4, letterSpacing: '.04em', fontFamily: 'var(--sans)' }}>
