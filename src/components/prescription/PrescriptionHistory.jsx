...
<body>
  <div style="border:2px solid var(--blue);border-radius:8px;padding:28px 32px">
    <div style="margin-bottom:16px;padding-bottom:16px;border-bottom:2px solid var(--blue)">
      <div style="font-family:'IBM Plex Sans',system-ui,sans-serif;font-size:15px;font-weight:800;color:var(--blue)">Facultad de Veterinaria - UDI</div>
      <div style="font-size:12px;color:var(--soft)">Universidad para el Desarrollo y la Innovacion - Santa Cruz</div>
    </div>
    <h2 style="font-size:14px;font-weight:800;text-align:center;color:var(--dark);margin-bottom:4px;letter-spacing:.04em;font-family:'IBM Plex Sans',system-ui,sans-serif">RECETA MEDICO-VETERINARIA</h2>
